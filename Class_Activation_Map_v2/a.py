...
src = skimage.transform.resize(overlay, [i_h ,i_w]) * 255
#print(src)
print(src.shape)
...
canny = cv2.Canny(gray, threshold1 = 100, threshold2 = 255, apertureSize = 5)
...
'''
plt.imshow(one_img)
plt.imshow(dst, alpha=0.5,cmap='jet', vmin=0.5)
plt.show()